# Notulen Bimbingan TA

1. Bimbingan 1: 6 Februari 2026 <br>
  Progress: Membaca paper rujukan <br>
  Diskusi: Diskusi arah topik TA <br>
  Plan: Membaca paper rujukan untuk memahami topik. Membuat pertanyaan penelitian terkait dual process pada moral reasoning. <br>
2. Bimbingan 2: 13 Februari 2026 (online) <br>
  Progress: Membaca paper rujukan, membuat pertanyaan penelitian <br>
  Diskusi: Diskusi pertanyaan penelitian <br>
  Plan: Revisi pertanyaan penelitian, merumuskan metodologi penelitian <br>
3. Bimbingan 3: 20 Februari 2026 <br>
  Progress: Revisi pertanyaan penelitian, membuat flow metodologi penelitian <br>
  Diskusi: Diskusi pertanyaan penelitian <br>
  Plan: Cari/buat kode eksperimen. Mulai eksperimen. Mulai membuat laporan. <br>
4. Bimbingan 4: 27 Februari 2026 <br>
  Progress: Membuat kode untuk eksperimen. Membuat file laporan. Revisi pertanyaan penelitian. Membuat latar belakang penelitian. <br>
  Diskusi: Diskusi dataset dan alur eksperimen <br>
  Plan: Revisi pertanyaan penelitian. Membaca research paper tentang dataset. <br>
5. Bimbingan 5: 6 Maret 2026 <br>
  Progress: Revisi pertanyaan penelitian. Membaca research paper tentang dataset. Membuat prompt dan flow yang dipakai dalam eksperimen <br>
  Diskusi: Diskusi dataset dan prompt yang dibuat <br>
  Plan: Mulai eksperimen. Membaca research paper tentang dataset. Memperbaiki prompt yang digunakan. <br>
6. Bimbingan 6: 17 Maret 2026 (online) <br>
  Progress: Update progress eksperimen menggunakan SLM pada subtask deontology. Membaca research paper tentang dataset. Menjelaskan pembuatan prompt <br>
